System.register(['angular2/core', './data', '../domain/user'], function(exports_1, context_1) {
    "use strict";
            ...
            MembershipService = (function () {
                ...
                MembershipService.prototype.getLoggedInUser = function () {
                    ...
                    if (this.isUserAuthenticated()) {
                        ...
                        _user = new user_1.User(_userData.Email, _userData.Password);
                    }
                    return _user;
                };
