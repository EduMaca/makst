...
System.register(['angular2/core', 'angular2/common', 'angular2/platform/browser', 'angular2/http', 'angular2/router', 'rxjs/add/operator/map', './routes', './core/services/data', './core/services/membership', './core/services/utility'], function(exports_1, context_1) {
    "use strict";
